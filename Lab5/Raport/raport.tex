...
\begin{figure}[H]
    ...
    \subfloat[Ox           ]{\includegraphics[width=\ww\linewidth]{../zad1/NoCut/I1/I_Origin.png}} \hfill%	
    \subfloat[HS(Ox)       ]{\includegraphics[width=\ww\linewidth]{../zad1/NoCut/I1/I_No_Cut.png}} \hfill% wypełnenie
    \subfloat[HE(Ox)       ]{\includegraphics[width=\ww\linewidth]{../zad1/NoCut/I1/I_Histeq.png}} \\
    \subfloat[H(Ox)     \\ k1 = 0.28627 \\ k2 = 2.3275 \\ k3 = 1 \\ k4 = 0.010884 \\ min(I) = 0 \\ max(I) = 0.28627 ]{\includegraphics[width=\ww\linewidth]{../zad1/NoCut/I1/H_Origin.png}} \hfill%	
    \subfloat[H(HS(Ox)) \\ k1 = 1 \\ k2 = 2.3275 \\ k3 = 1 \\ k4 = 0.13281 \\ min(I) = 0 \\ max(I) = 1 ]{\includegraphics[width=\ww\linewidth]{../zad1/NoCut/I1/H_No_Cut.png}} \hfill
    \subfloat[H(HE(Ox)) \\ k1 = 1 \\ k2 = 2.0034 \\ k3 = 1 \\ k4 = 0.34362 \\ min(I) = 0 \\ max(I) = 1 ]{\includegraphics[width=\ww\linewidth]{../zad1/NoCut/I1/H_Histeq.png}} 
...
\begin{figure}[H]
    \captionsetup[subfloat]{justification=raggedright,singlelinecheck=false, position=bottom,labelformat=empty} %
    \subfloat[Ox           ]{\includegraphics[width=\ww\linewidth]{../zad1/NoCut/I2/I_Origin.png}} \hfill%	
    \subfloat[HS(Ox)       ]{\includegraphics[width=\ww\linewidth]{../zad1/NoCut/I2/I_No_Cut.png}} \hfill% wypełnenie
    \subfloat[HE(Ox)       ]{\includegraphics[width=\ww\linewidth]{../zad1/NoCut/I2/I_Histeq.png}} \\
    \subfloat[H(Ox)     \\ k1 = 0.76078 \\ k2 = 2.4201 \\ k3 = 1 \\ k4 = 0.15035 \\ min(I) = 0 \\ max(I) = 0.76078 ]{\includegraphics[width=\ww\linewidth]{../zad1/NoCut/I2/H_Origin.png}} \hfill%	
    \subfloat[H(HS(Ox)) \\ k1 = 1 \\ k2 = 2.4201 \\ k3 = 1 \\ k4 = 0.25977 \\ min(I) = 0 \\ max(I) = 1 ]{\includegraphics[width=\ww\linewidth]{../zad1/NoCut/I2/H_No_Cut.png}} \hfill
    \subfloat[H(HE(Ox)) \\ k1 = 1 \\ k2 = 2.001 \\ k3 = 1 \\ k4 = 0.34525 \\ min(I) = 0 \\ max(I) = 1 ]{\includegraphics[width=\ww\linewidth]{../zad1/NoCut/I2/H_Histeq.png}} 
    \caption{Tekst do zmiany} 
...
\begin{figure}[H]
    \captionsetup[subfloat]{justification=raggedright,singlelinecheck=false, position=bottom,labelformat=empty} %
    \subfloat[Ox           ]{\includegraphics[width=\ww\linewidth]{../zad1/NoCut/I3/I_Origin.png}} \hfill%	
    \subfloat[HS(Ox)       ]{\includegraphics[width=\ww\linewidth]{../zad1/NoCut/I3/I_No_Cut.png}} \hfill% wypełnenie
    \subfloat[HE(Ox)       ]{\includegraphics[width=\ww\linewidth]{../zad1/NoCut/I3/I_Histeq.png}} \\
    \subfloat[H(Ox)     \\ k1 = 0.81961 \\ k2 = 1.479 \\ k3 = 1 \\ k4 = 0.16253 \\ min(I) = 0 \\ max(I) = 0.81961 ]{\includegraphics[width=\ww\linewidth]{../zad1/NoCut/I3/H_Origin.png}} \hfill%	
    \subfloat[H(HS(Ox)) \\ k1 = 1 \\ k2 = 1.479 \\ k3 = 1 \\ k4 = 0.24194 \\ min(I) = 0 \\ max(I) = 1 ]{\includegraphics[width=\ww\linewidth]{../zad1/NoCut/I3/H_No_Cut.png}} \hfill
    \subfloat[H(HE(Ox)) \\ k1 = 1 \\ k2 = 1.9995 \\ k3 = 1 \\ k4 = 0.34542 \\ min(I) = 0 \\ max(I) = 1 ]{\includegraphics[width=\ww\linewidth]{../zad1/NoCut/I3/H_Histeq.png}} 
    \caption{Tekst do zmiany} 
...
\begin{figure}[H]
    \captionsetup[subfloat]{justification=raggedright,singlelinecheck=false, position=bottom,labelformat=empty} %
    \subfloat[Ox           ]{\includegraphics[width=\ww\linewidth]{../zad1/NoCut/I4/I_Origin.png}} \hfill%	
    \subfloat[HS(Ox)       ]{\includegraphics[width=\ww\linewidth]{../zad1/NoCut/I4/I_No_Cut.png}} \hfill% wypełnenie
    \subfloat[HE(Ox)       ]{\includegraphics[width=\ww\linewidth]{../zad1/NoCut/I4/I_Histeq.png}} \\
    \subfloat[H(Ox)     \\ k1 = 0.99216 \\ k2 = 31.319 \\ k3 = 0.98444 \\ k4 = 0.013196 \\ min(I) = 0.0078431 \\ max(I) = 1 ]{\includegraphics[width=\ww\linewidth]{../zad1/NoCut/I4/H_Origin.png}} \hfill%	
    \subfloat[H(HS(Ox)) \\ k1 = 1 \\ k2 = 41.625 \\ k3 = 1 \\ k4 = 0.013405 \\ min(I) = 0 \\ max(I) = 1 ]{\includegraphics[width=\ww\linewidth]{../zad1/NoCut/I4/H_No_Cut.png}} \hfill
    \subfloat[H(HE(Ox)) \\ k1 = 1 \\ k2 = 2.0148 \\ k3 = 1 \\ k4 = 0.14579 \\ min(I) = 0 \\ max(I) = 1 ]{\includegraphics[width=\ww\linewidth]{../zad1/NoCut/I4/H_Histeq.png}} 
    \caption{Tekst do zmiany} 
...
\begin{figure}[H]
    \captionsetup[subfloat]{justification=raggedright,singlelinecheck=false, position=bottom,labelformat=empty} %
    \subfloat[$\text{Ox}_\text{+b\&w}$                ]{\includegraphics[width=\ww\linewidth]{../zad1/WithCut/I1/I_Origin.png}} \hfill%	
    \subfloat[HSc($\text{Ox}_\text{+b\&w}$ ,p1)       ]{\includegraphics[width=\ww\linewidth]{../zad1/WithCut/I1/I_Cut_P1.png}} \hfill% wypełnenie
    \subfloat[HSc($\text{Ox}_\text{+b\&w}$ ,p1)       ]{\includegraphics[width=\ww\linewidth]{../zad1/WithCut/I1/I_Cut_P2.png}} \\
    \subfloat[H($\text{Ox}_\text{+b\&w}$)          \\ k1 = 1 \\ k2 = 8.1303 \\ k3 = 1 \\ k4 = 0.010888 \\ min(I) = 0 \\ max(I) = 1 ]{\includegraphics[width=\ww\linewidth]{../zad1/WithCut/I1/H_Origin.png}} \hfill%	
    \subfloat[H(HSc($\text{Ox}_\text{+b\&w}$ ,p1)) \\ k1 = 1 \\ k2 = 2.485 \\ k3 = 1 \\ k4 = 0.15298 \\ min(I) = 0 \\ max(I) = 1 ]{\includegraphics[width=\ww\linewidth]{../zad1/WithCut/I1/H_Cut_P1.png}} \hfill
    \subfloat[H(HSc($\text{Ox}_\text{+b\&w}$ ,p1)) \\ k1 = 1 \\ k2 = 2.3309 \\ k3 = 1 \\ k4 = 0.24966 \\ min(I) = 0 \\ max(I) = 1 ]{\includegraphics[width=\ww\linewidth]{../zad1/WithCut/I1/H_Cut_P2.png}} 
    \caption{Tekst do zmiany} 
...
\begin{figure}[H]
    \captionsetup[subfloat]{justification=raggedright,singlelinecheck=false, position=bottom,labelformat=empty} %
    \subfloat[$\text{Ox}_\text{+b\&w}$                ]{\includegraphics[width=\ww\linewidth]{../zad1/WithCut/I2/I_Origin.png}} \hfill%	
    \subfloat[HSc($\text{Ox}_\text{+b\&w}$ ,p1)       ]{\includegraphics[width=\ww\linewidth]{../zad1/WithCut/I2/I_Cut_P1.png}} \hfill% wypełnenie
    \subfloat[HSc($\text{Ox}_\text{+b\&w}$ ,p1)       ]{\includegraphics[width=\ww\linewidth]{../zad1/WithCut/I2/I_Cut_P2.png}} \\
    \subfloat[H($\text{Ox}_\text{+b\&w}$)          \\ k1 = 1 \\ k2 = 3.181 \\ k3 = 1 \\ k4 = 0.15035 \\ min(I) = 0 \\ max(I) = 1 ]{\includegraphics[width=\ww\linewidth]{../zad1/WithCut/I2/H_Origin.png}} \hfill%	
    \subfloat[H(HSc($\text{Ox}_\text{+b\&w}$ ,p1)) \\ k1 = 1 \\ k2 = 2.6407 \\ k3 = 1 \\ k4 = 0.30172 \\ min(I) = 0 \\ max(I) = 1 ]{\includegraphics[width=\ww\linewidth]{../zad1/WithCut/I2/H_Cut_P1.png}} \hfill
    \subfloat[H(HSc($\text{Ox}_\text{+b\&w}$ ,p1)) \\ k1 = 1 \\ k2 = 2.6705 \\ k3 = 1 \\ k4 = 0.32133 \\ min(I) = 0 \\ max(I) = 1 ]{\includegraphics[width=\ww\linewidth]{../zad1/WithCut/I2/H_Cut_P2.png}} 
    \caption{Tekst do zmiany} 
...
\begin{figure}[H]
    \captionsetup[subfloat]{justification=raggedright,singlelinecheck=false, position=bottom,labelformat=empty} %
    \subfloat[$\text{Ox}_\text{+b\&w}$                ]{\includegraphics[width=\ww\linewidth]{../zad1/WithCut/I3/I_Origin.png}} \hfill%	
    \subfloat[HSc($\text{Ox}_\text{+b\&w}$ ,p1)       ]{\includegraphics[width=\ww\linewidth]{../zad1/WithCut/I3/I_Cut_P1.png}} \hfill% wypełnenie
    \subfloat[HSc($\text{Ox}_\text{+b\&w}$ ,p1)       ]{\includegraphics[width=\ww\linewidth]{../zad1/WithCut/I3/I_Cut_P2.png}} \\
    \subfloat[H($\text{Ox}_\text{+b\&w}$)          \\ k1 = 1 \\ k2 = 1.8045 \\ k3 = 1 \\ k4 = 0.16253 \\ min(I) = 0 \\ max(I) = 1 ]{\includegraphics[width=\ww\linewidth]{../zad1/WithCut/I3/H_Origin.png}} \hfill%	
    \subfloat[H(HSc($\text{Ox}_\text{+b\&w}$ ,p1)) \\ k1 = 1 \\ k2 = 1.5869 \\ k3 = 1 \\ k4 = 0.3154 \\ min(I) = 0 \\ max(I) = 1 ]{\includegraphics[width=\ww\linewidth]{../zad1/WithCut/I3/H_Cut_P1.png}} \hfill
    \subfloat[H(HSc($\text{Ox}_\text{+b\&w}$ ,p1)) \\ k1 = 1 \\ k2 = 1.7267 \\ k3 = 1 \\ k4 = 0.41726 \\ min(I) = 0 \\ max(I) = 1 ]{\includegraphics[width=\ww\linewidth]{../zad1/WithCut/I3/H_Cut_P2.png}} 
    \caption{Tekst do zmiany} 
...
\begin{figure}[H]
    \captionsetup[subfloat]{justification=raggedright,singlelinecheck=false, position=bottom,labelformat=empty} %
    \subfloat[$\text{Ox}_\text{+b\&w}$                ]{\includegraphics[width=\ww\linewidth]{../zad1/WithCut/I4/I_Origin.png}} \hfill%	
    \subfloat[HSc($\text{Ox}_\text{+b\&w}$ ,p1)       ]{\includegraphics[width=\ww\linewidth]{../zad1/WithCut/I4/I_Cut_P1.png}} \hfill% wypełnenie
    \subfloat[HSc($\text{Ox}_\text{+b\&w}$ ,p1)       ]{\includegraphics[width=\ww\linewidth]{../zad1/WithCut/I4/I_Cut_P2.png}} \\
    \subfloat[H($\text{Ox}_\text{+b\&w}$)          \\ k1 = 1 \\ k2 = 31.566 \\ k3 = 1 \\ k4 = 0.013199 \\ min(I) = 0 \\ max(I) = 1 ]{\includegraphics[width=\ww\linewidth]{../zad1/WithCut/I4/H_Origin.png}} \hfill%	
    \subfloat[H(HSc($\text{Ox}_\text{+b\&w}$ ,p1)) \\ k1 = 1 \\ k2 = 119.81 \\ k3 = 1 \\ k4 = 0.013842 \\ min(I) = 0 \\ max(I) = 1 ]{\includegraphics[width=\ww\linewidth]{../zad1/WithCut/I4/H_Cut_P1.png}} \hfill
    \subfloat[H(HSc($\text{Ox}_\text{+b\&w}$ ,p1)) \\ k1 = 1 \\ k2 = 4.6968 \\ k3 = 1 \\ k4 = 0.093701 \\ min(I) = 0 \\ max(I) = 1 ]{\includegraphics[width=\ww\linewidth]{../zad1/WithCut/I4/H_Cut_P2.png}} 
    \caption{Tekst do zmiany} 
...
\begin{figure}[H]
    \captionsetup[subfloat]{justification=raggedright,singlelinecheck=false, position=bottom,labelformat=empty} %
    \subfloat[Ox           ]{\includegraphics[width=\ww\linewidth]{../zad2/Local/I1/I_Origin.png}} \hfill%	
